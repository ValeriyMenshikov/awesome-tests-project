...
class LoginCredentials(BaseModel):
    ...
    login: Optional[str] = Field(None, title="Login")
    password: Optional[str] = Field(None, title="Password")
    remember_me: Optional[bool] = Field(None, alias="rememberMe", title="Rememberme")
...
class LogoutAuthLogoutDeleteResponse200(RootModel[Any]):
    root: Any


class LogoutAllAuthLogoutAllDeleteResponse200(LogoutAuthLogoutDeleteResponse200):
    pass
